      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <FadeIn delay={0.15}>
          <div className="mt-8 sm:mt-10">
            <a
              href="#"
              className="inline-flex items-center gap-2 px-7 sm:px-8 py-3.5 sm:py-4 bg-text-primary text-bg text-sm font-medium rounded-full hover:bg-white/90 transition-colors duration-200 active:scale-[0.98]"
            >
        ...
        <FadeIn delay={0.25}>
          <p className="mt-5 sm:mt-6 text-[10px] sm:text-xs text-text-muted">
